package com.V4Creations.mydrive.view.fragment;
...
import com.V4Creations.mydrive.R;
import com.V4Creations.mydrive.UploadFiles;
import com.V4Creations.mydrive.controller.ResourceLoaderManager;
import com.V4Creations.mydrive.controller.adapter.DirectoryListingAdapter;
import com.V4Creations.mydrive.model.ResourceItem;
import com.V4Creations.mydrive.model.ResourceStackItem;
import com.V4Creations.mydrive.model.interfaces.ResourceLoaderInterface;
import com.V4Creations.mydrive.view.activity.AndroidServerDirectoryListingMainActivity;
...
public class DirectoryListingFragment extends ListFragment implements
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		MenuItem newMenuItem=menu.findItem(R.id.menu_new);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_refresh:
			...
			return true;
		case R.id.menu_new:
			Intent i=new Intent(getActivity().getApplication().getApplicationContext(), UploadFiles.class);
			startActivity(i);
		}
		return false;
	}
